/*
    Tämän 't4.js' koodi on käytännössä sama kuin 't3.js'.
    Ainut ero on sarjan puuttuvan kuvan käsittely.
    Tässä tiedostossa laitetaan puuttuvan kuvan paikalle
    netistä haettava 'Not found'-kuva.
    'Not found'-kuva voisi olla myös omassa img-kansiossa.
 */
...
tvForm.addEventListener('submit', async function (evt) {
    ...
    try {
        ...
        for (const tvShow of jsonData) {
             ...
             */
            // ns. kysymysmerkki-tekniikka (pikakoodausta, kaikki eivät tykkää)
            // jos show.image löytyy -> valitaan '?' jälkeen oleva eka vaihtoehto,
            // muuten valitaan toinen vaihtoehto. Vaihtoehdot erotellaan ':' merkillä
